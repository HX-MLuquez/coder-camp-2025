    ...
    <div style={containerStyle} onClick={toggleSidebar}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <p style={paragraphStyle}>
          ...
          laboral se refiere al proceso de conseguir un empleo, mientras que la
          empleabilidad implica tener las habilidades y competencias necesarias
          para mantener y avanzar en un trabajo.
        </p>
        <p style={paragraphStyle}>
          Y buscar empleo es un trabajo en sí mismo. Requiere tiempo, esfuerzo y
          una estrategia clara. Aquí te dejamos algunos consejos y recursos
          útiles para mejorar tu empleabilidad y facilitar tu inserción laboral.
        </p>
      </div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <ul style={listStyle}>
          ...
          <li style={listItemStyle}>
            Una marca personal sólida puede diferenciarte de otros candidatos y
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <p style={{ ...paragraphStyle, color: "#4b5563" }}>
            ...
            extracurriculares puede ser una excelente manera de desarrollarlas.
          </p>
        </div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ ...paragraphStyle, color: "#4b5563" }}>
          Estas habilidades son cada vez más valoradas en el mercado laboral, ya
          que las máquinas y la inteligencia artificial aún no pueden replicar
          completamente estas capacidades humanas.
        </p>
      </div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={paragraphStyle}>
          Estas habilidades se cultivan a través de la experiencia, la formación
          continua y la apertura al cambio. Los profesionales que invierten en
          su desarrollo personal y profesional tienen más probabilidades de
          destacar en el mercado laboral.
        </p>
      </div>

      <div style={highlightStyle}>
        <h2 style={highlightTitleStyle}>¿Qué se espera del Mercado Laboral?</h2>
        <p style={paragraphStyle}>
        ...
        <p style={paragraphStyle}>
          Por lo tanto, es crucial mantenerse actualizado y ser proactivo en el
          desarrollo de nuevas habilidades. Y van a desaparecer 92 millones de
          puestos de trabajo que hoy existen, lo que implica que la
        ...
        <p style={paragraphStyle}>
          En términos porcentuales, esos números representan aproximadamente un
          14 % de empleo nuevo, un 8 % de empleos desaparecidos, y un 7 % de
          aumento neto respecto a la situación actual.
        </p>
      </div>
      ...
      <div style={exerciseStyle}>
        <h2 style={sectionTitleStyle}>Ejercicio de reinvención profesional</h2>
        ...
        >
          <p style={exerciseTextStyle}>
            ...
            logros significativos]. Actualmente, estoy buscando oportunidades en
            [sector o tipo de trabajo deseado], donde pueda aplicar mis
            habilidades en [habilidades específicas] y contribuir al éxito de la
            empresa."
          </p>
        </div>
      </div>
