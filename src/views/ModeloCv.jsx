    ...
    <div style={containerStyle} onClick={toggleSidebar}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          <h4 style={subSectionTitleStyle}>1. Contexto: Futuro del trabajo</h4>
          <ul style={listStyle}>
        ...
        <div>
          <h4 style={subSectionTitleStyle}>3. Cómo buscar ofertas laborales</h4>
          <ul style={listStyle}>
            <li style={listItemStyle}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <ul style={listStyle}>
            ...
            <li style={listItemStyle}>
              Reflexionar sobre mis experiencias pasadas y cómo han influido en
          ...
          <div style={{ marginTop: "1rem" }}>
            ...
            <ul style={listStyle}>
              ...
              <li style={listItemStyle}>
                Habilidades de liderazgo: [Describir experiencias de liderazgo y
                gestión de equipos]
              </li>
              <li style={listItemStyle}>
          ...
          <div style={{ marginTop: "1rem" }}>
            ...
            <p style={paragraphStyle}>
              [Describir objetivos profesionales a corto, mediano y largo plazo]
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <ul style={listStyle}>
            ...
            <li style={listItemStyle}>
              Analizar las tendencias del mercado laboral y las habilidades más
              demandadas.
            </li>
            <li style={listItemStyle}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <ul style={listStyle}>
          ...
          <li style={listItemStyle}>
            <strong>Estrategia. Palabras clave:</strong> Incluir palabras clave
            relevantes para el puesto al que se postula, basadas en la
          ...
          <li style={listItemStyle}>
            <strong>Evitar:</strong> datos personales innecesarios, como estado
            civil o foto. Evitar información no solicitada y formatos jpg.
          </li>
        </ul>
      </div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <ul style={listStyle}>
          <li style={listItemStyle}>
            <strong>Acceso al mercado oculto:</strong> Muchas ofertas laborales
            no se publican en portales de empleo, por lo que es importante
            construir una red de contactos.
          </li>
          <li style={listItemStyle}>
            <strong>Desarrollo profesional:</strong> Aprender de otros, obtener
            mentoría y consejos de profesionales con más experiencia.
          </li>
          <li style={listItemStyle}>
